...
class Livestock extends CI_Controller {
    ...
    public function addNewView() {
        $data = array();
        $data['settings'] = $this->settings_model->getSettings();
        $data['livestock'] = $this->livestock_model->getAllAnimals(); 
    ...
    public function addNew() {
        ...
        $this->form_validation->set_rules('lineage', 'Lineage', 'trim|required|xss_clean');
        $this->form_validation->set_rules('tag', 'Tag', 'trim|required|min_length[1]|max_length[100]|xss_clean');
    ...
    function editLivestock() {
        ...
        $data['livestock'] = $this->livestock_model->getAllAnimals(); // Fetch all animals
        $this->load->view('home/dashboard', $data); // just the header file
        $this->load->view('add_new', $data);
